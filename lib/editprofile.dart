  ...
  void initState() {
    ...
    get.once().then((value) async {
      ...
      if (snap.exists) {
        ...
        setState(() {
          instaurl.text = map["Insta"];
          fburl.text = map["FB"];
          linkedinurl.text = map["LinkedIn"];
        });
      }
    });
  }
            ...
            child: SingleChildScrollView(
              ...
              children: [
                                ...
                                snapshot.snapshotEvents
                                  ...
                                  switch (taskSnapshot.state) {
                                    ...
                                    case TaskState.success:
                                      ...
                                      String? minemail =
                                          mymail.replaceAll(".", "");
                                      DatabaseReference refe = FirebaseDatabase
                                          .instance
                                          .ref("UserData/$minemail/PhotoUrl");
                                      await refe.set(imageUrl);
                                      setState(() {
                                        PhotoUrlp = imageUrl;
                                        showp = false;
                                      });
                ...
                showt
                    ? Text("$prog% Uploaded",
                        style: const TextStyle(
                            fontFamily: 'chivo', color: Color(0xff8a8989)))
                    : const SizedBox(
                        height: 0,
                      ),
                const SizedBox(
                ...
                Padding(
                  ...
                  child: TextField(
                    style: const TextStyle(
                        fontSize: 20, color: Colors.black, fontFamily: 'martel'),
                ...
                Container(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    items:
                        halllist.map<DropdownMenuItem<String>>((String value) {
                      return DropdownMenuItem<String>(
                        value: value,
                        child: Text(
                          value,
                            ...
                            if (year == "Year") {
                              ...
                              if (dept == "Dept") {
                                ...
                                if (hall == "Hall") {
                                  ...
                                  await refe.set(json);
                                  DatabaseReference yu = FirebaseDatabase.instance
                                      .ref("Social Links/$minemail");
                                  final nn = {
                                    "Insta": instaurl.text,
                                    "FB": fburl.text,
                                  ...
                                  await FirebaseMessaging.instance
                                      .unsubscribeFromTopic(Departmentp);
                                  await FirebaseMessaging.instance
                                      .unsubscribeFromTopic(Hallp);
                                  await FirebaseMessaging.instance
                                      .subscribeToTopic(dept);
                                  await FirebaseMessaging.instance
                                      .subscribeToTopic(hall);
