...
class _AcademicState extends State<Academic> {
  ...
  Widget build(BuildContext context) {
    DatabaseReference reference =
        FirebaseDatabase.instance.ref("Academic/$Departmentp");
    ...
    reference.orderByChild("ID").onChildAdded.listen((DatabaseEvent value) {
      ...
      setState(() {
        if (lista.length != joa) {
          if (lista.length < joa) {
            if (idsa.contains(map["ID"])) {
            } else {
              idsa.insert(0, map["ID"]);
              lista.insert(0, de);
            }
          } else if (lista.length > joa) {
            setState(() {
              lista.clear();
              idsa.clear();
              idsa.insert(0, map["ID"]);
          ...
          if (updatea) {
            itemScrollController.jumpTo(index: cindexa);
            cindexa = 0;
            updatea = false;
          }
        }
    ...
    return countbool
      ...
      child: ScrollablePositionedList.builder(
          ...
          itemBuilder: (_, index) {
            String name = lista[index].Name;
            String photoUrl = lista[index].PhotoUrl;
            String emailId = lista[index].Email_ID;
            String hall = lista[index].Hall;
            String year = lista[index].Year;
            String department = lista[index].Department;
            String post = lista[index].Post;
            String iD = lista[index].ID;
            int comments = lista[index].Comment;
            String fileUrl = lista[index].FileUrl;
            bool showi = lista[index].showi;
            bool showd = lista[index].showd;
            ...
            gh.once().then((value) async {
              ...
              if (snap.exists) {
                Map<dynamic, dynamic> map = snap.value as Map;
                setState(() {
                  lista[index].Comment = map["Comment"];
                });
              }
            });
                ...
                children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  ...
                                  ),lista[index].sb ? Image.asset('images/verr.png', width: 20, height: 20,) : SizedBox(width: 0,),
                                  ]
                              ),
                            ),
                            Text(
                              ...
                              Widget yes = TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  DatabaseReference delref = FirebaseDatabase
                                      .instance
                                      .ref("MyPost/$minemail/Academic/$iD");
                                  await delref.remove();

                                  DatabaseReference delre = FirebaseDatabase
                                      .instance
                                      .ref("Academic/$department/$iD");
                                  await delre.remove();
                                  setState(() {
                                    lista.clear();
                                    idsa.clear();
                                    ...
                                    FirebaseDatabase.instance.ref(
                                        "Academic/$Departmentp"); //academic path
                                    reference.once().then((value) {
                                      DataSnapshot snap = value.snapshot;
                                      Map<dynamic, dynamic> map = snap.value as Map;
                                      jor = map.length;
                            ...
                            onPressed: () async {
                              ...
                              Widget yes = TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  String link =
                                      "mailto:jdcodekgp@gmail.com?subject=KGPanchayat Post Report&body=Post Details: Dept-" +
                                          iD +
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.start,
                    mainAxisAlignment: MainAxisAlignment.start,children: [
                      ...
                      GestureDetector(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text(lista[index].like.toString(),
                      ...
                      lista[index].sp ? IconButton(onPressed: () {
                        setState(() {
                          DatabaseReference beta =
                          FirebaseDatabase.instance.ref("Saved/$minemail/$iD/");
                          beta.remove();
