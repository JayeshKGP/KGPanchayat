...
class _LostState extends State<Lost> {
  ...
  Widget build(BuildContext context) {
    DatabaseReference reference = FirebaseDatabase.instance.ref("Lost");
    ...
    reference.orderByChild("ID").onChildAdded.listen((DatabaseEvent value) {
      ...
      setState(() {
        if (listl.length != j) {
          if (listl.length < j) {
            if (idsl.contains(map["ID"])) {
            } else {
              idsl.insert(0, map["ID"]);
              listl.insert(0, de);
            }
          } else if (listl.length > j) {
            setState(() {
              listl.clear();
              idsl.clear();
              listl.insert(0, de);
          ...
          if (update) {
            itemScrollController.jumpTo(index: cindexl);
            cindexl = 0;
            updatel = false;
          }
        }
    ...
    return countbool
      ...
      child: ScrollablePositionedList.builder(
          ...
          itemCount: listl.length,
          itemBuilder: (_, index) {
            String name = listl[index].Name;
            String photoUrl = listl[index].PhotoUrl;
            String emailId = listl[index].Email_ID;
            String hall = listl[index].Hall;
            String year = listl[index].Year;
            String department = listl[index].Department;
            String post = listl[index].Post;
            String iD = listl[index].ID;
            int comments = listl[index].Comment;
            String fileUrl = listl[index].FileUrl;
            bool showi = listl[index].showi;
            bool showd = listl[index].showd;
            ...
            gh.once().then((value) async {
              ...
              if (snap.exists) {
                Map<dynamic, dynamic> map = snap.value as Map;
                setState(() {
                  listl[index].Comment = map["Comment"];
                });
              }
            });
                ...
                children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  ...
                                  ),listl[index].sb ? Image.asset('images/verr.png', width: 20, height: 20,) : SizedBox(width: 0,),
                                  ]
                              ),
                            ),
                            Text(
                            ...
                            onPressed: () async {
                              ...
                              Widget yes = TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  String link = "mailto:jdcodekgp@gmail.com?subject=KGPanchayat Post Report&body=Post Details: Lost-"+iD+"\nPost reported by $Namep, $EmailIdp\nReason of reporting:";
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.start,
                    mainAxisAlignment: MainAxisAlignment.start,children: [
                      ...
                      GestureDetector(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text(listl[index].like.toString(),
                      ...
                      listl[index].sp ? IconButton(onPressed: () {
                        setState(() {
                          DatabaseReference beta =
                          FirebaseDatabase.instance.ref("Saved/$minemail/$iD/");
                          beta.remove();
