...
class MessageOutbox extends StatefulWidget {
  const MessageOutbox({Key? key}) : super(key: key);

  @override
  State<MessageOutbox> createState() => _MessageOutboxState();
}

class _MessageOutboxState extends State<MessageOutbox> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseDatabase.instance.ref("OutMessages/$minemail");
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          ...
          body: countbool
              ? Center(child: const Text("Messages you send will be visible here", style: TextStyle(color: Colors.black, fontSize: 20, fontFamily: 'glory', fontWeight: FontWeight.bold)))
              : Container(
                                          ...
                                          onPressed: () async {
                                            ...
                                            Widget yes = TextButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                String? je = emailId.replaceAll("@", '');
                                                String? postmail = je.replaceAll(".", "");
                                                DatabaseReference delref = FirebaseDatabase.instance.ref("Messages/$postmail/$iD");
                                                await delref.remove();
                                                DatabaseReference delre = FirebaseDatabase.instance.ref("OutMessages/$minemail/$iD");
                                                await delre.remove();
                                                Navigator.of(context).pop();
                                              },
                                            );
