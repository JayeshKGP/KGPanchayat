...
class _EventState extends State<Event> {
  ...
  Widget build(BuildContext context) {
    DatabaseReference reference = FirebaseDatabase.instance.ref("Event");
    ...
    reference.orderByChild("ID").onChildAdded.listen((DatabaseEvent value) {
      ...
      setState(() {
        if (liste.length != joe) {
          ...
          if (update) {
            itemScroll.jumpTo(index: cindexe);
            cindexe = 0;
            update = false;
    ...
    return countbool
      ...
      child: ScrollablePositionedList.builder(
          ...
          itemBuilder: (_, index) {
            String name = liste[index].Name;
            String photoUrl = liste[index].PhotoUrl;
            String emailId = liste[index].Email_ID;
            String hall = liste[index].Hall;
            String year = liste[index].Year;
            String department = liste[index].Department;
            String post = liste[index].Post;
            String iD = liste[index].ID;
            int comments = liste[index].Comment;
            String fileUrl = liste[index].FileUrl;
            bool showi = liste[index].showi;
            bool showd = liste[index].showd;
            ...
            gh.once().then((value) async {
              ...
              if (snap.exists) {
                Map<dynamic, dynamic> map = snap.value as Map;
                setState(() {
                  liste[index].Comment = map["Comment"];
                });
              }
            });
                ...
                children: [
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                  ...
                                  ),liste[index].sb ? Image.asset('images/verr.png', width: 20, height: 20,) : SizedBox(width: 0,),
                                  ]
                              ),
                            ),
                            Text(
                            ...
                            onPressed: () async{
                              ...
                              Widget yes = TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  String link = "mailto:jdcodekgp@gmail.com?subject=KGPanchayat Post Report&body=Post Details: Event-"+iD+"\nPost reported by $Namep, $EmailIdp\nReason of reporting:";
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.start,
                    mainAxisAlignment: MainAxisAlignment.start,children: [
                      ...
                      GestureDetector(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text(liste[index].like.toString(),
                      ...
                      liste[index].sp ? IconButton(onPressed: () {
                        setState(() {
                          DatabaseReference beta =
                          FirebaseDatabase.instance.ref("Saved/$minemail/$iD/");
                          beta.remove();
